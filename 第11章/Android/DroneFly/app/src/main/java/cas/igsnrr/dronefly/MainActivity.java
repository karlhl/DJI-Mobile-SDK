...
public class MainActivity extends AppCompatActivity {
    ...
    private static final String[] PERMISSION_LIST = new String[]{
            ...
            Manifest.permission.RECORD_AUDIO // 录音 - 当使用喊话器附件等情况时需要该权限
    };
    // 缺失的用户权限
    ...
    private void initUI(){
        ...
        // 获得“在地图中显示无人机位置(高德地图)”按钮实例对象
        Button btnGaodeMap = findViewById(R.id.btn_map_gaode);
        // 对“在地图中显示无人机位置(高德地图)”按钮增加监听器
        btnGaodeMap.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (checkDroneConnection() == false) {
                    return;
        ...
        // 获得“在地图中显示无人机位置(OpenLayers)”按钮实例对象
        Button btnMap = findViewById(R.id.btn_map);
        // 对“在地图中显示无人机位置(OpenLayers)”按钮增加监听器
        ...
        // 获得“访问相机存储(Playback)”按钮实例对象
        Button btnPlayback = findViewById(R.id.btn_playback);
        // 对“访问相机存储(Playback)”按钮增加监听器
        ...
        // 获得“Mavic2行业版附件”按钮实例对象
        Button btnAccessoryAggregation = findViewById(R.id.btn_accessory_aggregation);
        // 对“Mavic2行业版附件”按钮增加监听器
        btnAccessoryAggregation.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (checkDroneConnection() == false) {
                    return;
                }
                // 弹出AccessoryAggregationActivity
                Intent i = new Intent(MainActivity.this, AccessoryAggregationActivity.class);
                startActivity(i);
            }
        });
        // 获得“航点任务”按钮实例对象
        Button btnWaypointMission = findViewById(R.id.btn_waypoint_mission);
        // 对“航点任务”按钮增加监听器
        btnWaypointMission.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (checkDroneConnection() == false) {
                    return;
                }
                // 弹出WaypointMissionActivity
                Intent i = new Intent(MainActivity.this, WaypointMissionActivity.class);
                startActivity(i);
            }
        });
        // 获得“时间线任务”按钮实例对象
        Button btnTimelineMission = findViewById(R.id.btn_timeline_mission);
        // 对“时间线任务”按钮增加监听器
        btnTimelineMission.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (checkDroneConnection() == false) {
                    return;
                }
                // 弹出TimelineMissionActivity
                Intent i = new Intent(MainActivity.this, TimelineMissionActivity.class);
                startActivity(i);
            }
        });
        // 获得“UX SDK”按钮实例对象
        Button btnUXSDK = findViewById(R.id.btn_uxsdk);
        // 对“UX SDK”按钮增加监听器
        btnUXSDK.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (checkDroneConnection() == false) {
                    return;
                ...
                // 弹出UXSDKActivity
                Intent i = new Intent(MainActivity.this, UXSDKActivity.class);
                startActivity(i);
            }
        });
    }
                ...
                DJISDKManager.getInstance().registerApp(MainActivity.this.getApplicationContext(),
                    new DJISDKManager.SDKManagerCallback() {
                        ...
                        public void onProductChanged(BaseProduct baseProduct) {
                            ...
                            showToast("设备变化:" + baseProduct.getModel().getDisplayName());
                        }
